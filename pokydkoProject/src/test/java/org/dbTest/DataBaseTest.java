...
public class DataBaseTest {
    ...
    public void setUpDB() throws SQLException, ClassNotFoundException {
        ...
        logger.info("Connection to MySQL DB was successful");
    ...
    public void testDataFromDB() throws SQLException, ClassNotFoundException {
        ...
        final String LOGIN = "G13_Vladislav";
        ...
        int numberOfEffectedRows = mySQLDatabase
                .changeTable("INSERT INTO seleniumTable VALUES('12334234', '%s', '%s')", LOGIN, "1238459");
