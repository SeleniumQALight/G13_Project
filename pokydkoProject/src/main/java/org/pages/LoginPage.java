...
import org.testdata.RegistrationValidationMessages;
import org.utils.Utils_Custom;

import java.util.List;

import static org.testdata.RegistrationValidationMessages.SEMICOLON;
...
//        logger.info("Button Sign In was clicked");
    ...
    public LoginPage checkErrorsMessages(String expectedMessages) {
        ...
        webDriverWait10.withMessage("Number of error messages is not as expected")
                .until(ExpectedConditions.numberOfElementsToBe(By.xpath(listOfActualMessagesLocator), expectedErrorsArray.length));
        ...
        for (int i = 0; i < expectedErrorsArray.length; i++) {
            softAssertions.assertThat(listOfActualMessages.get(i).getText())
                    ...
                    //.isEqualTo(expectedErrorsArray[i]);
                    .isIn(expectedErrorsArray);
        }

        softAssertions.assertAll(); // to collect all assertion results - MUST HAVE
        return this;
    }
}
