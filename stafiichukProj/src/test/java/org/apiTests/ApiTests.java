...
public class ApiTests extends BaseTestApi {
    ...
    public void getAllPostsByUser() {
        PostsDto[] actualResponse = given()
                ...
                .body("[0].title", equalTo("New post from API Taras G12"))
        ...
        PostsDto[] expectedResult = {
                new PostsDto("New post from API Taras G12",
                        "post body",
                        "One Person",
                        "no",
    ...
    public void getAllPostsByUserNegative() {
        ...
        Assert.assertEquals("Message in response", "\"Sorry, invalid user requested. Wrong username - " +NOT_VALID_USER_NAME+ " or there is no posts. Exception is undefined\"", actualResult);
