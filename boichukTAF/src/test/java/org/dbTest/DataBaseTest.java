...
import org.pages.utils.DB_Util_seleniumTable;
import org.pages.utils.Database;
import org.pages.utils.MySQL_Database;
...
public class DataBaseTest {
    ...
    public void testDataFromDB() throws SQLException, ClassNotFoundException {
        ...
        final String LOGIN = "G-13_Boichuk";
        ...
        int numberOfEffectedRows = mySQLDatabase
                .changeTable("INSERT INTO seleniumTable VALUES('11474','%s','%s')", LOGIN, "12345");
        ...
        int numberOfDeleteRows = mySQLDatabase
                .changeTable("DELETE FROM seleniumTable WHERE login = '%s'", LOGIN);
        Assert.assertEquals("Number of deleted rows", 1, numberOfDeleteRows);
