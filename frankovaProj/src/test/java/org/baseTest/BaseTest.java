...
//для накопичення скріншотів, які будуть додаватися до звіту аллюр
protected ArrayList<ScreenShot> listOfScreenShots = new ArrayList<>();

    @Before
    public void setup() {
        logger.info("Test name: " + testName.getMethodName() + " was started");
 ...
 /*       WebDriverManager.chromedriver().setup();
    ...
    //дає отримати назву тесту, який зараз виконується
    @Rule
    ...
    private WebDriver initDriver() {
        ...
        if (browserFromProperty == null){
            logger.info("Browser from property is null. Starting Chrome as default browser");
    ...
    public void tearDown() {
        logger.info("Test name: " + testName.getMethodName() + " was finished");
       /* webDriver.quit();
