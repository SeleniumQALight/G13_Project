...
public class Hook {
    ...
    @Before(value = "@deletePostsTillPresentForDefaultUser", order = 50) //буде запущений останнім
    @After (value = "@deletePostsTillPresentForDefaultUser", order = 50) //буде запущений першим
