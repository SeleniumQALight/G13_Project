...
public class ValidationMessagesTest extends BaseTest {
    ...
    public void TC03_testValidationMessages(User userData, String expectedMessages) {
    ...
    public Object[][] parametersForTestValidationMessages() {
        return new Object[][]{
                ...
                {new User("TC03").updateUserName(User.SHORT_USERNAME_NOT_VALID)
                        ...
                        .updatePassword(User.SHORT_PASSWORD_NOT_VALID),ERROR_USERNAME + SEMICOLON + ERROR_EMAIL + SEMICOLON + ERROR_PASSWORD},
                // {"oleg", "tr1", "tr2", ERROR_EMAIL + SEMICOLON + ERROR_PASSWORD},
                {new User("TC03").updateEmail(User.SHORT_EMAIL_NOT_VALID)
                        .updatePassword(User.SHORT_PASSWORD_NOT_VALID), ERROR_EMAIL + SEMICOLON + ERROR_PASSWORD},
                //{"oleg", "tr1", "123456qwerty", ERROR_EMAIL}
                {new User("TC03").updateEmail(User.SHORT_EMAIL_NOT_VALID)
                        .updatePassword(User.PASSWORD_MIN_LENGTH), ERROR_EMAIL}
        };
    }
}
